...
import { fetchBrandAttentionList, clearBrandAttention } from '@/api/memberBrandAttention.js';
...
export default {
  ...
  onNavigationBarButtonTap(e) {
    ...
    if (index === 0) {
      uni.showModal({
        title: 'Notice',
        content: 'Do you want to clear all followed brands?',
  ...
  methods: {
    // Load brand list, supports pull-down refresh and infinite scroll
    async loadData(type = 'add', loading) {
      // Return directly if there is no more data
      if (type === 'add') {
