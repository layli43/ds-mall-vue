<template>
	<view class="container">
		<!-- Mini Program Header Compatibility -->
		<!-- #ifdef MP -->
		<view class="mp-search-box">
			<input class="ser-input" type="text" value="Enter keyword to search" disabled />
		</view>
		<!-- #endif -->

		<!-- Header Carousel -->
		<view class="carousel-section">
			<!-- Title bar and status bar placeholder -->
		...
		<view class="f-header m-t" @click="navToRecommendBrandPage()">
			...
			<view class="tit-box">
				<text class="tit">Brand Manufacturers Direct Supply</text>
				<text class="tit2">Factory-to-consumer, removing brand markup</text>
			</view>
		...
		<view class="f-header m-t" v-if="homeFlashPromotion!==null">
			...
			<view class="tit-box">
				...
				<text class="tit2">Next session starts at {{homeFlashPromotion.nextStartTime | formatTime}}</text>
			</view>
			<view class="tit-box">
				<text class="tit2" style="text-align: right;">Time left in this session:</text>
		...
		<view class="f-header m-t" @click="navToNewProudctListPage()">
			...
			<view class="tit-box">
				<text class="tit">New Arrivals</text>
				<text class="tit2">Discover great new items for you</text>
			</view>
			<text class="yticon icon-you"></text>
		</view>
		...
		<view class="f-header m-t" @click="navToHotProudctListPage()">
			...
			<view class="tit-box">
				<text class="tit">Popular Recommendations</text>
				<text class="tit2">Everyone is loving these</text>
			</view>
			<text class="yticon icon-you"></text>
		</view>
		...
		<view class="f-header m-t">
			...
			<view class="tit-box">
				<text class="tit">You May Like</text>
